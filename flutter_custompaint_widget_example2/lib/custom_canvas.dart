...
class CoolCanvas extends CustomPainter {
  CoolCanvas({
    ...
    this.maxRadius = 1.0,
    this.rightCircleAngle = 1.0,
    this.rightCircleCenter = const Offset(10.0, 10.0),
    this.rightCircleRadius = 1.0,
    this.leftCircleAngle = 1.0,
    this.leftCircleCenter = const Offset(20.0, 20.0),
    this.leftCircleRadius = 1.0,
  }) {
