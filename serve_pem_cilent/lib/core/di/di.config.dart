...
import '../../features/serve_pem/data/repositories/serve_pem_repository_impl.dart'
    as _i95;
import '../../features/serve_pem/data/services/registration_encryptor.dart'
    as _i379;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i379.RegistrationEncryptor>(
    ...
    gh.lazySingleton<_i654.ServePemRepository>(
