...
class _TextFieldControllerJasprDemoState
    ...
    return div([
      _card(
        ...
        children: [
          ...
          _outputText('Live preview: ${name.isEmpty ? '(empty)' : name}'),
        ],
      ),
      _card(
        ...
        children: [
          ...
          div([
            ...
            button(
              ...
              onClick: () => setState(
                () => submittedMessage = message.isEmpty
  ...
  Component _textInput({
    ...
    return div([
      ...
      input<String>(
        ...
        onInput: onInput,
        styles: _inputStyles,
        attributes: {'autocomplete': 'off', 'placeholder': placeholder},
      ),
  ...
  Component _outputText(String text) {
    return p([Component.text(text)], styles: _outputStyles);
  }
}
...
const _stackStyles = Styles(
  raw: {'display': 'grid', 'gap': '16px', 'margin-top': '24px'},
);
...
const _cardTitleStyles = Styles(
  raw: {'margin': '0 0 8px 0', 'font-size': '1.15rem', 'font-weight': '700'},
);

const _descriptionStyles = Styles(
  raw: {'margin': '0', 'color': '#51607a', 'line-height': '1.6'},
);

const _cardBodyStyles = Styles(
  raw: {'display': 'grid', 'gap': '14px', 'margin-top': '16px'},
);

const _fieldGroupStyles = Styles(raw: {'display': 'grid', 'gap': '8px'});

const _labelStyles = Styles(
  raw: {'font-size': '0.95rem', 'font-weight': '600'},
);
...
const _buttonRowStyles = Styles(
  raw: {'display': 'flex', 'flex-wrap': 'wrap', 'gap': '12px'},
);
