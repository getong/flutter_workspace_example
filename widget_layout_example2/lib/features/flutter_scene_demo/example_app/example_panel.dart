...
class _ExamplePanelCardState extends State<ExamplePanelCard> {
  ...
  // to bound the scrolling body. The host app's theme renders the header a
  // little taller than the upstream example app's, so this allowance is
  // larger than upstream's 57 to keep the card from overflowing its slot.
  static const double _headerAllowance = 72;
