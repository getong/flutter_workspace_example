...
class CustomMultiChildLayoutShowcase extends StatelessWidget {
  const CustomMultiChildLayoutShowcase({super.key, required this.example});

  final CustomMultiChildLayoutExample example;
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: _buildExamplePreview(example.type),
            ),
  ...
  Widget _buildExamplePreview(CustomMultiChildLayoutExampleType type) {
    return switch (type) {
      CustomMultiChildLayoutExampleType.profileHeader =>
        const _ProfileHeaderLayout(),
      CustomMultiChildLayoutExampleType.mediaControls =>
        const _MediaControlsLayout(),
      CustomMultiChildLayoutExampleType.boardingPass =>
