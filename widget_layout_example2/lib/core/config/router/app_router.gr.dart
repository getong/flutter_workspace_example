...
/// generated route for
/// [DioCookieManagerPage]
class DioCookieManagerRoute extends PageRouteInfo<void> {
  const DioCookieManagerRoute({List<PageRouteInfo>? children})
    : super(DioCookieManagerRoute.name, initialChildren: children);

  static const String name = 'DioCookieManagerRoute';

  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      return const DioCookieManagerPage();
    },
  );
}
...
/// generated route for
/// [FlutterAdvancedSwitchPage]
class FlutterAdvancedSwitchRoute extends PageRouteInfo<void> {
  const FlutterAdvancedSwitchRoute({List<PageRouteInfo>? children})
    : super(FlutterAdvancedSwitchRoute.name, initialChildren: children);

  static const String name = 'FlutterAdvancedSwitchRoute';

  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      return const FlutterAdvancedSwitchPage();
    },
  );
}
...
/// generated route for
/// [FlutterRustBridgeSuiPage]
class FlutterRustBridgeSuiRoute extends PageRouteInfo<void> {
  const FlutterRustBridgeSuiRoute({List<PageRouteInfo>? children})
    : super(FlutterRustBridgeSuiRoute.name, initialChildren: children);

  static const String name = 'FlutterRustBridgeSuiRoute';
...
/// generated route for
/// [GrpcDemoPage]
class GrpcDemoRoute extends PageRouteInfo<void> {
  const GrpcDemoRoute({List<PageRouteInfo>? children})
    : super(GrpcDemoRoute.name, initialChildren: children);

  static const String name = 'GrpcDemoRoute';

  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      return const GrpcDemoPage();
    },
  );
}
...
class InjectableGetItRoute extends PageRouteInfo<void> {
  const InjectableGetItRoute({List<PageRouteInfo>? children})
    : super(InjectableGetItRoute.name, initialChildren: children);

  static const String name = 'InjectableGetItRoute';

  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      return const InjectableGetItPage();
    },
  );
}
...
class PopScopeRoute extends PageRouteInfo<void> {
  const PopScopeRoute({List<PageRouteInfo>? children})
    : super(PopScopeRoute.name, initialChildren: children);

  static const String name = 'PopScopeRoute';
