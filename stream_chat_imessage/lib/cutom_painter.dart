...
class ChatBubble extends CustomPainter {
  ...
  ChatBubble({required this.color, required this.hasTail, this.alignment})
    : paintFill = Paint()
        ..color = color
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (alignment == Alignment.topRight) {
      ...
      path.arcToPoint(
        const Offset(buffer, cornerSize),
        radius: const Radius.circular(cornerSize),
        clockwise: false,
      );
      ...
      if (hasTail) {
        ...
        path.arcToPoint(
          Offset(cornerSize + innerTailWidth, size.height),
          radius: const Radius.circular(cornerSize),
          clockwise: false,
        );
      } else {
        ...
        path.arcToPoint(
          Offset(buffer + cornerSize, size.height),
          radius: const Radius.circular(cornerSize),
          clockwise: false,
        );
      }
