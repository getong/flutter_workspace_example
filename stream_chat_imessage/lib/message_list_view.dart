...
import 'package:stream_chat_imessage/message_header.dart';
import 'package:stream_chat_imessage/message_input.dart';
import 'package:stream_chat_imessage/message_widget.dart';
                      ...
                      children: [
                        ...
                        ...entries[index]
                            ...
                            .map((entry) {
                              ...
                              final received = isReceived(message, context);
                              return (received)
                                  ? MessageWidget(
