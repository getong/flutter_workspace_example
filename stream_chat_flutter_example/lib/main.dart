...
Future<void> main() async {
  ...
  final client = StreamChatClient('s2dxdhpxd94g', logLevel: Level.OFF);
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      builder: (context, widget) => StreamChat(client: client, child: widget),
...
class ChannelListPage extends StatefulWidget {
  const ChannelListPage({super.key, this.onTap, this.selectedChannel});
        ...
        children: <Widget>[
          Expanded(
            child: StreamMessageListView(
              ...
              messageBuilder:
                  (context, messageDetails, messages, defaultWidget) {
