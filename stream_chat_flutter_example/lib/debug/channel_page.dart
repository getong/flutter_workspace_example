...
class _DebugChannelPageState extends State<DebugChannelPage> {
  ...
  void initState() {
    ...
    _ownUserSubscription = _channel.client.state.currentUserStream.listen((
      ownUser,
    ) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(_channel.name ?? _channel.cid ?? '?')),
...
class DebugMe extends StatelessWidget {
  const DebugMe({super.key, required this.client});
